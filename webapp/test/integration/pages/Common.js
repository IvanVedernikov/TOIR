sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ru/rosneft/breakdown/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#Breakdown-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#Breakdown-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("ru.rosneft.breakdown.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ru/rosneft/breakdown/localService/mockserver"], function (mockserver) {
